...
![](resources/5085638F3937035901A1CC2CCDCD6314)
...
![](resources/8249E701E78BCC5561B70AE91006BDBA)
...
![](resources/505C68C01D425DF59B2B76A426230A6D)
...
![](resources/31C6FDC64CD4EBCCC729BDD639AA787A)
...
![](resources/888148887EF4E588A5DDFDFFE171D193)
...
![](resources/94469869C035A45A113B17A10D2BECD4)
...
![](resources/E82D5BE91EAB4C4E46D75B194BC70045)

**第二轮循环**

* 栈空后，先执行微任务队列中的 `then()`方法，输出 `4`，此时微任务队列为空。

![](resources/F13530223917097C8BFF6AE0D4CCED93)

* 读取宏任务队列的最靠前的任务 `setTimeout1`。
* 先直接执行打印语句，打印日志 `1`，又遇到微任务 `then()`，加入微任务队列。第二轮循环结束。

![](resources/7FA6C569C5D93A3A1B7E3770980204F7)

**第三轮循环**

* 先执行微任务队列中的 `then()`方法，输出 `2`，此时微任务队列为空。

![](resources/AB5C94150D3FCB46FA2887E1FAD8A56E)

* 继续读取宏任务队列的最靠前的任务 `setTimeout2`。
* 直接执行打印语句，打印日志 `3`。第三轮循环结束，执行完毕。

![](resources/4FCDFD0F0B71E528CDC40B14A3648856)
